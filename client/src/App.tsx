...
import TrialUpgradePage from "@/pages/trial-upgrade-page";
...
import ClinicAdminUsers from "@/pages/clinic-admin-users";
import ClinicAdminLocations from "@/pages/clinic-admin-locations";
...
import { ProfilePhotoCapture } from "@/pages/profile-photo-capture";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <ProtectedRoute path="/clinic-admin/locations" component={ClinicAdminLocations} />
      ...
      {/* Profile Photo Capture - Public route for QR code access */}
      <Route path="/capture-profile/:sessionId" component={ProfilePhotoCapture} />
